<?php
if (!class_exists("StringClass")) include("StringClass.php");
if (!class_exists("ObjectClass")) include("ObjectClass.php");
if (!class_exists("ReflectionClass")) include("ReflectionClass.php");
